...
function submitEvent(e) {
    ...
    if (form.checkValidity()) {
        const tasks = (0,_taskData_js__WEBPACK_IMPORTED_MODULE_1__.getTasks)();
        let task = (0,_taskFactory_js__WEBPACK_IMPORTED_MODULE_0__["default"])(tasks.length, title.value, description.value, capitalizeFirstLetter(list.value), dueDate.value, priority.value, notes.value, check.checked);
