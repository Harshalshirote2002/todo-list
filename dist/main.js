...
function updateSpace(index, taskId){
...
function spaceUpdater(task){
    ...
    for(const space of spaces){
        if(space.title===task.project){
            (0,_spaces_js__WEBPACK_IMPORTED_MODULE_2__.updateSpace)(space.index, task.id);
            return;
        }
    }
...
function submitEvent(e) {
    ...
    if (form.checkValidity()) {
        ...
        let task = (0,_taskFactory_js__WEBPACK_IMPORTED_MODULE_0__["default"])(id, title.value, description.value, list.value, dueDate.value, priority.value, notes.value, check.value);
